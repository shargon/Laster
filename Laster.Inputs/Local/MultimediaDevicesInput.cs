...
namespace Laster.Inputs.Local
{
    ...
    public class MultimediaDevicesInput : IDataInput
    {
        ...
        {
            readonly IMMDeviceEnumerator _deviceEnumerator;
            ...
            public void OnDefaultDeviceChanged(EDataFlow dataFlow, ERole deviceRole, string pwstrDefaultDeviceId) { OnChange?.Invoke(this, EventArgs.Empty); }
